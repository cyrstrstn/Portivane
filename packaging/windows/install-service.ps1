...
Set-ItemProperty -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Run' -Name PortivaneTray -Value "powershell.exe -WindowStyle Hidden -ExecutionPolicy Bypass -File `"$installDir\portivane-tray.ps1`"" -Type String
